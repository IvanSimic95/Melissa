...
$redirectPayment = "https://melissapsy.pay.clickbank.net/?cbskin=38670&cbitems=".$cbproduct."&name=".$user_name."&email=".$user_email."&cookie_ID=".$cookie_id."&order_ID=".$lastRowInsert;
